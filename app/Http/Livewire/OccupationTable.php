...
final class OccupationTable extends PowerGridComponent
{
    use ActionButton;
    ...
    */
     ...
     *
     * @return Builder<\App\Models\Occupation>
     */
    ...
    */
    ...
    /**
     * PowerGrid Occupation Action Buttons.
     *
    ...
    public function actions(): array
    {
        return [
            Button::make('edit', 'Editar')
                ...
                ->route('occupation.edit', ['id' => 'id']),

            Button::make('destroy', 'Excluir')
                ->target('')
                ->class('bg-red-500 cursor-pointer text-white px-3 py-2 m-1 rounded text-sm')
                ->route('occupation.confirm_delete', ['id' => 'id']),
        ];
    }
    ...
    */
    ...
    /**
     * PowerGrid Occupation Action Rules.
     *
    ...
    public function actionRules(): array
    {
       return [
           ...
           //Hide button edit for ID 1
            Rule::button('edit')
                ->when(fn($occupation) => $occupation->id === 1)
                ->hide(),
        ];
    }
    */
