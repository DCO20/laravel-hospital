...
final class DoctorTable extends PowerGridComponent
{
    ...
    */
    ...
    {
        return [
            'specialty' => [ // relationship on dishes model
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('email')
            ->addColumn('phone')
            ->addColumn('specialty_id', function (Doctor $model) {
    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Especialidade', 'specialty_id')
                ->sortable()
                ->searchable(),
    ...
    public function actions(): array
    {
        return [
            ...
            Button::make('destroy', 'Excluir')
                ...
                ->route('doctor.confirm_delete', ['id' => 'id']),
        ];
    }
